...
public class DebugDrawB2D extends DebugDraw {
...
//        g.drawLine((int) temp.x, (int) temp.y, (int) temp2.x, (int) temp2.y);
    ...
    @Override
    public void drawParticles(Vec2[] vec2s, float v, ParticleColor[] particleColors, int i) {

    }

    // TODO: Implement drawParticlesWireframe
    @Override
    public void drawParticlesWireframe(Vec2[] vec2s, float v, ParticleColor[] particleColors, int i) {
