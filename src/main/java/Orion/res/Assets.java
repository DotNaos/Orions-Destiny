...
public class Assets {
    ...
    public static final Spritesheet BLOCKS_SPRITESHEET = new Spritesheet(AssetManager.getTexture(BLOCKS), 16, 16, 81, 0);
    public static final Spritesheet TURTLE_SPRITESHEET = new Spritesheet(AssetManager.getTexture(TURTLE), 16, 24, 4, 0);
    public static final Spritesheet BIG_PLAYER_SPRITESHEET = new Spritesheet(AssetManager.getTexture(BIG_PLAYER), 16, 32, 42, 0);
    public static final Spritesheet PIPES_SPRITESHEET = new Spritesheet(AssetManager.getTexture(PIPES), 32, 32, 4, 0);
    public static final Spritesheet ITEMS_SPRITESHEET = new Spritesheet(AssetManager.getTexture(ITEMS), 16, 16, 43, 0);
    public static final Spritesheet GIZMOS_SPRITESHEET = new Spritesheet(AssetManager.getTexture(GIZMOS), 24, 48, 3, 0);
