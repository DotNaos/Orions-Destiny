 ...
 * The PickingTexture class represents a framebuffer object used for off-screen rendering.
 * <p>
 * It allows to pick objects in the scene by rendering the object's id to a texture.
 * By reading the pixel at the mouse position, we can get the id of the object pixel perfect.
 * <br>
 * The id is stored in the red, green and blue channels of the texture.
 * <br>
 */
