...
public class MouseListener {
    ...
    public static float getScreenX()
    {
        ...
        currentX = (currentX / (float)get().gameViewportSize.x) * Window.getWidth();
        return currentX;
    }
    ...
    public static float getScreenY()
    {
        ...
        currentY = Window.getHeight() -((currentY / (float)get().gameViewportSize.y) * Window.getHeight());
    ...
    public static void setGameViewportPos(Vector2f pos) {
        get().gameViewportPos.set(pos);
    }

    public static void setGameViewportSize(Vector2f size) {
        get().gameViewportSize.set(size);
    }
}